...
cleaned_data['literacy_rate_group'] = pd.cut(df['adult_literacy_rate'], bins=4, labels=["Low", "Medium", "High", "Very High"])


plt.figure(figsize=(8, 6))

sns.barplot(x='literacy_rate_group', y='gdp_per_capita', data=cleaned_data, palette='Blues')
